...
function Header(props) {
  ...
  const [connectflag, setConnectflag] = useState(true);
  const closemodal = () => {
    setModalflag(false)
  }
  const showmodal = () => {
      ...
      <div className="mobile-link-part" style={{ display: modalflag ? 'block' : 'none' }}>
        ...
        <div style={{marginTop:'50px'}}>
          <div className="mobile-link-con">
            <a href="#home" className="link-btn link-mb" onClick={closemodal}>Home</a>
          </div>
          <div className="mobile-link-con">
            <a href="#mint" className="link-btn link-mb" onClick={closemodal}>Mint</a>
          </div>
          <div className="mobile-link-con">
            <a href="#roadmap" className="link-btn link-mb" onClick={closemodal}>Roadmap</a>
          </div>
          <div className="mobile-link-con">
            <a href="#icon" className="link-btn link-mb" onClick={closemodal}>The&nbsp;Icons</a>
          </div>
          <div className="mobile-link-con">
            <a href="#token" className="link-btn link-mb" onClick={closemodal}>Tokens</a>
          </div>
        </div>
      </div>
          ...
          <div className="left-nav">
            <div className="link-part">
              <div className="link-con-sm">
                <a href="#home" className="link-btn small-link">Home</a>
              </div>
              <div className="link-con-sm">
                <a href="#mint" className="link-btn small-link">Mint</a>
              </div>
              <div className="link-con-sm">
                <a href="#roadmap" className="link-btn small-link">Roadmap</a>
              </div>
              <div className="link-con-bg">
                <a href="#icon" className="link-btn big-link">The&nbsp;Icons</a>
              </div>
              <div className="link-con-bg">
                <a href="#token"p className="link-btn big-link">Tokens</a>
              </div>
              <div className="link-con-bg">
                {connectflag ? <button className="connect-wallet" href="#roadmap" onClick={connect}>Connect</button> : <button className="connect-wallet" href="#roadmap" onClick={connect}>Disconnect</button>}
